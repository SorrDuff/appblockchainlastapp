...
Future<void> _createClass(String className) async {
    final response = await http.post(
      Uri.parse('http://YOUR_SERVER_IP:3000/createClass'),
    ...
    if (response.statusCode == 200) {
      ...
      if (responseBody['success']) {
        final joinCode = responseBody['joinCode'];
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Join code is: $joinCode')),
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                if (newCode.isNotEmpty &&
                  ...
                  Navigator.of(context).pop();
                  _createClass(newName); // Call the API to create a new class.
                } else {
